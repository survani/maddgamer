		...
		<>
			<div className='flex justify-center'>
				<div className='bg-white w-1/2 p-16 rounded-lg'>
					...
					<p>Effective Date: 12-Jan-2023 Last Updated: 12-Jan-2023</p>
					&nbsp;
					<h5 className='font-semibold'>What are cookies?</h5>
					...
					&nbsp;
					<h5 className='font-semibold'>How do we use cookies?</h5>
					<div class='cookie-policy-p'>
						<p>
					...
					&nbsp;
					<h5 className='font-semibold'>Types of Cookies we use</h5>
					<div class='cky-audit-table-element'></div>
					&nbsp;
					<h5 className='font-semibold'>Manage cookie preferences</h5>
					<br></br>
