	...
	return (
		<>
			<div className='flex justify-center'>
				<div className='bg-white w-1/2 p-16 rounded-lg'>
					<h1 className='font-semibold text-2xl mb-2'>Privacy Policy</h1>
					<p className='text-slate-500 mb-4'>Last updated: January 12, 2023</p>
					<p className='mb-4'>
					...
					<h2 className='font-semibold text-xl mb-2'>Interpretation</h2>
					<p className='mb-4'>
					...
					<h2 className='font-semibold text-xl mb-2'>Definitions</h2>
					...
					<ul>
						...
						<li className='mb-2'>
							<p>
								...
								in this Agreement) refers to MaddGamer.
							</p>
						</li>
						<li className='mb-2'>
							<p>
						...
						<li className='mb-2'>
							<p>
								<strong>Website</strong> refers to MaddGamer, accessible from{" "}
								<a
									href='https://www.maddgamer.com/'
									rel='external nofollow noopener'
									target='_blank'
								>
									https://www.maddgamer.com/
								</a>
							</p>
						</li>
						<li className='mb-4'>
					...
					<h3 className='font-semibold text-lg mb-2'>Business Transactions</h3>
					<p>
					...
					<br></br>
					<h1 className='font-semibold text-xl mb-2'>Children's Privacy</h1>
					<p>
					...
					<ul>
						<li>
							<p>By email: contact@maddgamer.com</p>
						</li>
						<br></br>
						<li>
							<p>
								...
								<a
									href='https://www.maddgamer.com/contact'
									rel='external nofollow noopener'
									target='_blank'
								>
									https://www.maddgamer.com/contact
								</a>
							</p>
						</li>
					</ul>
