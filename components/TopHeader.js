...
const TopHeader = () => {
	return (
		<section className='d-none mx-2 bg-light d-lg-flex justify-content-center'>
			...
			<Link href='https://www.maddgamer.com/blog/our-most-anticipated-shooter-games-list-2023x'>
				<p>Most Anticipated Shooter Games 2023</p>
			</Link>
			<span className='mx-2'> | </span>
			<Link href='https://www.maddgamer.com/blog/mw2-and-warzone-20-all-season-2-updatesx'>
